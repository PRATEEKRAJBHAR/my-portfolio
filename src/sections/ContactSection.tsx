...
export function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="py-20 bg-white theme-dark:bg-gray-900"
    >
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 theme-dark:text-white">
                    Email
                  </h4>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm font-medium text-gray-700 theme-dark:text-gray-300 mb-2"
                >
                  Name
                </label>
